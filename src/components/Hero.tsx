...
export default function Hero() {
  return (
    <section className="relative min-h-screen mx-16 flex items-center justify-center bg-cream">
      <Image
        src="/bggg.webp"
        ...
        priority
      />
      <div className="absolute inset-0 bg-black/10 md:bg-black/50"></div>
      <div className="text-center px-4 py-24 max-w-2xl mx-auto flex-col gap-2">
